...
import com.barmanagement.util.AlertHelper;
...
public class HomeController implements Initializable {
    ...
    private void showDashboard(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang Dashboard: " + e.getMessage());
        }
    }
    ...
    private void showOrders(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang đơn hàng: " + e.getMessage());
        }
    }
    ...
    private void showMenu(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang menu: " + e.getMessage());
        }
    }
    ...
    private void showInventory(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang kho hàng: " + e.getMessage());
        }
    }
    ...
    private void showCustomers(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang khách hàng: " + e.getMessage());
        }
    }
    ...
    private void showStaff(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang nhân viên: " + e.getMessage());
        }
    }
    ...
    private void showReports(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang báo cáo: " + e.getMessage());
        }
    }
    ...
    private void showSettings(ActionEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở trang cài đặt: " + e.getMessage());
        }
    }
    ...
    private void showCocktails(MouseEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở danh mục Cocktails: " + e.getMessage());
        }
    }
    ...
    private void showBeers(MouseEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở danh mục Beers: " + e.getMessage());
        }
    }
    ...
    private void showWines(MouseEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở danh mục Wines: " + e.getMessage());
        }
    }
    ...
    private void showSpirits(MouseEvent event) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở danh mục Spirits: " + e.getMessage());
        }
    }
    ...
    private void searchAction(ActionEvent event) {
        if (searchField == null) {
            AlertHelper.showError("Lỗi", "Search field not found!");
            return;
        }

        String searchText = searchField.getText().trim();
        if (searchText.isEmpty()) {
            AlertHelper.showWarning("Tìm kiếm", "Vui lòng nhập từ khóa tìm kiếm!");
            return;
        }

        System.out.println("🔍 Searching for: " + searchText);
        AlertHelper.showInfo("Tìm kiếm", "Đang tìm kiếm: " + searchText);
    ...
    private void logout(ActionEvent event) {
        ...
        try {
            ...
            if (AlertHelper.showConfirmation("Đăng xuất", "Bạn có chắc chắn muốn đăng xuất?")) {
            ...
            AlertHelper.showError("Lỗi", "Không thể đăng xuất: " + e.getMessage());
        }
    }
    ...
    private void testCategoriesVisibility() {
        ...
        AlertHelper.showInfo("Debug", "Categories handlers are working!\nCheck console for details.\n\nHãy scroll xuống để thấy Categories!");
    }
    ...
    private void scrollToBottom() {
        if (mainScrollPane != null) {
            ...
            AlertHelper.showInfo("Scroll", "Đã scroll xuống cuối! Categories section phải hiển thị rồi!");
        } else {
            System.out.println("⚠️ ScrollPane not found - please scroll manually");
            AlertHelper.showInfo("Scroll", "Hãy scroll xuống cuối trang để thấy Categories!");
        }
    }
    ...
    public void showProductDetails(String productName) {
        ...
        AlertHelper.showInfo("Sản phẩm", "Xem chi tiết: " + productName);
    ...
    public void navigateToCategory(String category) {
        ...
        try {
            ...
            AlertHelper.showError("Lỗi", "Không thể mở danh mục " + category + ": " + e.getMessage());
        }
    }
